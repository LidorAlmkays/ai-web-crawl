...
/**
 * Kafka Task Pusher Script (Simplified Version)
 *
 ...
 *
 * This version avoids DTO decorator issues by creating the message structure directly.
 */
...
import { getKafkaTopicName } from '../src/config/kafka-topics';
import { kafkaTopicConfig } from '../src/config/kafka-topics';

/**
 * Kafka Task Pusher Class (Simplified)
 *
...
async function main(): Promise<void> {
	const pusher = new KafkaTaskPusherSimple();
	...
	try {
		...
		console.log('[INFO] ========================================');
		console.log('[INFO] Kafka Task Pusher Script Started (Simple Version)');
		console.log('[INFO] ========================================');
