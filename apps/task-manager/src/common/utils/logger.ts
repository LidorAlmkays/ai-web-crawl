...
const svcName = observabilityConfig.service.name;
// Visibility policy inferred from environment only
const isProd = observabilityConfig.service.environment === 'production';
const logsEndpoint = observabilityConfig.logs.endpoint;
const otelLogsEnabled = observabilityConfig.logs.enabled;
const environment = observabilityConfig.service.environment;
