-- PostgreSQL Metrics Functions for Task Manager
-- This file contains all metrics-related functions for the Task Manager service
...
-- This is the base function used by all specific status count functions
...
-- Returns a comprehensive view of all task metrics in a single call
