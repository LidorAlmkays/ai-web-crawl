...
import { IKafkaClientService } from '../interfaces/kafka-client.interface';
import { pinoLogCreator } from '../utils/kafka-log-creator';
...
export class KafkaClientService implements IKafkaClientService {
  ...
  constructor() {
    this.kafka = new Kafka({
      ...
      logLevel: logLevel.INFO, // Set the log level for kafkajs
      logCreator: pinoLogCreator, // Use our custom log creator
    });
...
export type { IKafkaClientService } from '../interfaces/kafka-client.interface';
