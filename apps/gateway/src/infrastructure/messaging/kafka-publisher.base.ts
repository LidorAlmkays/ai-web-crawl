...
import { IKafkaClientService } from './kafka/kafka-client.service';
import { KafkaMessageBuilder } from './kafka/kafka-message-builder';
import { IKafkaMessage } from './kafka/kafka-message.interface';
...
export abstract class KafkaPublisherBase {
  ...
  constructor(
    ...
    instanceId: string = process.env.INSTANCE_ID || 'default'
  ) {
